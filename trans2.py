...
parser.add_argument('-opt', type=str, help='Path to options YMAL file.', default="config/train/train_dsrnet_x4.yml")
...
paddle.save(ckpt_pd, 'trans_weights/trans_DSRNet_x4_600000.pdparams')
a = 1